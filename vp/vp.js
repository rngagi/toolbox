...
function wordlisttable(tlist,mylang){
	...
	//生出表格
	var content = '<table id="sort-table" data-toggle="table"><thead><tr><th data-field="word" data-sortable="true">詞項</th><th data-field="meaning" data-sortable="true">中文解釋</th><th data-field="level" data-sortable="true">級別</th></tr></thead>';
	content += '<tbody>';
